...
export class PropertiesController {
    private getPropertiesByStaffUseCase = Container.get(GetPropertiesByStaffUseCase);
    ...
    @Get("/:property_id")
    @HttpCode(200)
    getPropertyById(@Req() req: RequestWithUser, @Param('property_id') property_id: string) {
